<template>
  <section>
    ...
    <!--列表-->
    <el-table :data="attendances" highlight-current-row v-loading="listLoading" @selection-change="selsChange" style="width: 100%;">
...
<script>
  ...
  import { getAttendanceListPage, removeAttendance, batchRemoveAttendance, editAttendance, addAttendance } from './api';
  ...
  export default {
    ...
    methods: {
      ...
      getAttendances() {
        ...
        getAttendanceListPage(para).then((res) => {
          debugger;
          if( res && res.data){
      ...
      handleDel: function (index, row) {
        this.$confirm('确认删除该记录吗?', '提示', {
          ...
          //NProgress.start();
          let para = { id: row.id };
          removeAttendance(para).then((res) => {
            this.listLoading = false;
            //NProgress.done();
            this.$message({
              message: '删除成功',
      ...
      batchRemove: function () {
        ...
        this.$confirm('确认删除选中记录吗？', '提示', {
          ...
          //NProgress.start();
          let para = { ids: ids };
          batchRemoveAttendance(para).then((res) => {
