  ...
  <section>
    ...
    <el-col :span="24" class="toolbar" style="padding-bottom: 0px;">
      <el-form :inline="true" :model="filters">
        ...
        <el-form-item>
          <el-button type="primary" v-on:click="getPayments">查询</el-button>
        </el-form-item>
        <el-form-item>
    ...
    <!--列表-->
    <el-table :data="payments" highlight-current-row v-loading="listLoading" @selection-change="selsChange" style="width: 100%;">
...
<script>
  ...
  import { getPaymentListPage, removePayment, batchRemovePayment, editPayment, addPayment } from './api';
  ...
  export default {
    ...
    methods: {
      ...
      getPayments() {
        ...
        getPaymentListPage(para).then((res) => {
          debugger;
          if( res && res.data){
      ...
      batchRemove: function () {
        ...
        this.$confirm('确认删除选中记录吗？', '提示', {
          ...
          //NProgress.start();
          let para = { ids: ids };
          batchRemovePayment(para).then((res) => {
